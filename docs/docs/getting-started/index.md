...
Claude Code will clone the SpecGantry repository, register its skills and agents, and confirm with: `✓ Plugin installed: SpecGantry v5.2.6`
...
```
SpecGantry v5.2.6  |  Acme Platform  |  release 1.0.0
