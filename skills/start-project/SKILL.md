...
Invoke `spec-gantry:ideation:ideation-subagent` with `vision_statement: [vision]` and `project_dir: [absolute path of current working directory]`. After the subagent completes, run `/spec-gantry` to continue the pipeline.
