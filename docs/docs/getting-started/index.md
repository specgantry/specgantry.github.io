...
Claude Code will clone the SpecGantry repository, register its skills and agents, and confirm with: `✓ Plugin installed: SpecGantry v1.6.0`
...
```
SpecGantry v1.6.0  |  Acme Platform
